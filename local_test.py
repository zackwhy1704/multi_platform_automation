...
if __name__ == "__main__":
    ...
    print(f"  ElevenLabs Key: {'SET' if os.getenv('ELEVENLABS_API_KEY') else 'NOT SET (avatar video disabled)'}")
    print(f"  fal.ai Key:     {'SET' if os.getenv('FAL_KEY') else 'NOT SET (avatar video disabled)'}")
